...
one_day_detrend = row_difference(
    ta_data)  # Need to modify this function to loop over columns, at least the Close, Open,etc ones
'''Step 4: Split data into training/testing'''
x_train, x_test = train_test_split_custom(one_day_detrend)
'''Step 5: SS Transform'''
