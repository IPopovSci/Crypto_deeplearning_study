...
def create_lstm_model(x_t):
    ...
    LSTM_1 = LSTM(int(n_components*0.7), return_sequences=True, stateful=True, kernel_regularizer=regularizer,
    ...
    LSTM_2 = LSTM(int(n_components*0.5), return_sequences=True, stateful=True, kernel_regularizer=regularizer,
    ...
    attention_1 = Attention(int(n_components * 0.5))(LSTM_2)

    Dense_1 = tf.keras.layers.Dense(int(n_components * 0.5 ** 2), activation='selu')(attention_1)
