...
ticker = 'ethusd'
def continue_learning_batch(ticker, model,start,increment):
        ...
        mcp = ModelCheckpoint(
            os.path.join(f'F:\MM\models\ethusd\\',
...
continue_learning_batch(ticker, '0.00034652_0.00996967-best_model-01',1100000,50000)
